...
public class ReportDetails extends Activity {
	...
	private void saveToDatabase() {
		...
		Toast.makeText(this, "Report Sucessfully Updated", Toast.LENGTH_LONG)
				.show();
		startActivity(i);
		finish();
		}
		else{
			Toast.makeText(this, "Problem Updating Database, Operation Could not be Completed", Toast.LENGTH_LONG)
			.show();
